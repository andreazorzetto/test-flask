...
def parse_critical_and_high_vulnerabilities(input_file, output_json="critical_high_vulns.json", output_csv="critical_high_vulns.csv"):
        ...
        for match in scan_data.get('matches', []):
            ...
            if severity in ['CRITICAL', 'HIGH']:
                vuln = {
                    ...
                    'fixed_version': match.get('vulnerability', {}).get('fix', {}).get('versions', ['N/A'])[0] if match.get('vulnerability', {}).get('fix', {}).get('versions') else 'N/A',
